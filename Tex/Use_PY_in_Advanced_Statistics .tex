...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
        ...
        \PY{k}{def} \PY{n+nf}{mean\PYZus{}and\PYZus{}std\PYZus{}of\PYZus{}sample\PYZus{}mean}\PY{p}{(}\PY{n}{ss}\PY{o}{=}\PY{p}{[}\PY{p}{]}\PY{p}{,} \PY{n}{group\PYZus{}n}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{    不同大小样本均值的均值以及标准差}
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{n}{norm\PYZus{}dis} \PY{o}{=} \PY{n}{stats}\PY{o}{.}\PY{n}{norm}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}  \PY{c+c1}{\PYZsh{} 定义一个均值为0，标准差为2的正态分布}
            \PY{k}{for} \PY{n}{n} \PY{o+ow}{in} \PY{n}{ss}\PY{p}{:}
                \PY{n}{sample\PYZus{}mean} \PY{o}{=} \PY{p}{[}\PY{p}{]}  \PY{c+c1}{\PYZsh{} 收集每次取样的样本均值}
                \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{group\PYZus{}n}\PY{p}{)}\PY{p}{:}
                    \PY{n}{sample} \PY{o}{=} \PY{n}{norm\PYZus{}dis}\PY{o}{.}\PY{n}{rvs}\PY{p}{(}\PY{n}{n}\PY{p}{)}  \PY{c+c1}{\PYZsh{} 取样本量为n的样本}
                    \PY{n}{sample\PYZus{}mean}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{sample}\PY{p}{)}\PY{p}{)}  \PY{c+c1}{\PYZsh{} 计算该组样本的均值}
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{std}\PY{p}{(}\PY{n}{sample\PYZus{}mean}\PY{p}{)}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{sample\PYZus{}mean}\PY{p}{)}\PY{p}{)}
        
        \PY{n}{sample\PYZus{}size} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mi}{9}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{]}  \PY{c+c1}{\PYZsh{} 每组试验的样本量}
        \PY{n}{group\PYZus{}num} \PY{o}{=} \PY{l+m+mi}{10000}
        \PY{n}{mean\PYZus{}and\PYZus{}std\PYZus{}of\PYZus{}sample\PYZus{}mean}\PY{p}{(}\PY{n}{ss}\PY{o}{=}\PY{n}{sample\PYZus{}size}\PY{p}{,} \PY{n}{group\PYZus{}n}\PY{o}{=}\PY{n}{group\PYZus{}num}\PY{p}{)}
\end{Verbatim}
