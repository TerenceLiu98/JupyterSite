...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_30_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_30_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_32_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_32_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_36_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_36_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_40_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_40_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_45_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_45_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_48_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_48_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_52_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_52_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_58_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_58_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_97_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_101_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_105_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Use PY in Linear Algebra_files/Use PY in Linear Algebra_107_1.png}
    \end{center}
    { \hspace*{\fill} \\}
